    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rarity', models.CharField(choices=[('M', 'Mundane'), ('C', 'Common'), ('C', 'Unommon'), ('R', 'Rare'), ('VR', 'Very Rare'), ('L', 'Legendary'), ('A', 'Artifact')], db_index=True, default='M', max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rarity', models.CharField(choices=[('M', 'Mundane'), ('C', 'Common'), ('C', 'Unommon'), ('R', 'Rare'), ('VR', 'Very Rare'), ('L', 'Legendary'), ('A', 'Artifact')], db_index=True, default='M', max_length=2)),
                ('requires_attunement', models.BooleanField(default=False)),
                ('damage', models.CharField(db_index=True, max_length=255)),
